...
\begin{tabular}{|l|c|c|}
  ...
  \hline
  Accuracy & 74.04\% & 74.68\% \\
  Training duration (ms) & 623 & 12479 \\
  Testing duration (ms) & 13 & 136 \\
  \hline
\end{tabular}
\end{center}
...
To deploy a Spark cluster, Docker tools such as Swarm and Compose are used. % à détailler
...
% Agile with sprints, divided by use cases

\subsection{Tools}

% GitHub for source code hosting and issue tracking, Trello for task planning, Google Drive for project documents hosting, Docker Hub for Docker images hosting, Travis-CI for continuous testing, integration and deployment. 

\subsection{Issues}

% New language: scala, many parts to develop and connect together, video processing, new concept of machine learning
